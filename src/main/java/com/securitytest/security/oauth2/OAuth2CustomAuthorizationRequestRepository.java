...
@Component
public class OAuth2CustomAuthorizationRequestRepository<T extends OAuth2AuthorizationRequest> implements
    ...
    public OAuth2CustomAuthorizationRequestRepository(
